...
//RANK KISMI//
client.ranks = [
  { role: "878576843597414412", coin: 500 },
  { role: "878576843597414413", coin: 1000 },
  { role: "878576843597414414", coin: 1500 },
  { role: "878576843597414416", coin: 2000 },
  { role: ["878576843597414416","878576843563872313"], coin: 2500 },
  { role: "878576843597414417", coin: 3000 },
  { role: ["878576843597414418","878576843563872314"], coin: 4000 },
  { role: "878576843597414419", coin: 5000 },
  { role: "878576843614199818", coin: 6000 },
  { role: "878576843614199819", coin: 8000 },
  { role: "878576843614199820", coin: 10000 },
  { role: ["878576843614199821","878576843580661771"], coin: 12000 },
  { role: "878576843614199822", coin: 15000 },
  { role: "878576843614199823", coin: 20000 },
  { role: "878576843614199825", coin: 25000 },
  { role: "878576843614199826", coin: 30000 },
  { role: ["878576843614199827","878576843580661772"], coin: 50000 }
  ]
//KOMUT ÇALIŞTIRMA
fs.readdir('./src/commands/', (err, files) => {
  if (err) console.error(err);
  console.log(`[GALAXY] ${files.length} komut yüklenecek.`);
  files.forEach(f => {
    fs.readdir("./src/commands/" + f, (err2, files2) => {
      files2.forEach(file => {
        let props = require(`./src/commands/${f}/` + file);
        console.log(`[GALAXY KOMUT] ${props.conf.name} komutu yüklendi!`);
...
client
  ...
  .catch(() => console.log("[HATA VERİ AMINA KODUM] Bot Bağlanamadı!"));

setInterval(() => {
  let GuildID = "878576843454812210"
  let OneMonth = "878576843530326045"
  let ThreeMonth = "878576843530326046"
  let SixMonth = "878576843547099136"
  let NineMonth = "878576843547099137"
  let OneYear = "878576843547099138"
