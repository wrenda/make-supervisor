...
const { star, green, red , tag , icon , hosgeldinKonfeti , girdi , left ,davet } = require("../configs/emojis.json")
...
kayitchannel.wsend(`
${hosgeldinKonfeti} **Galaxy Sunucusuna Hoşgeldin** ${member}- \`${member.id}\` 
${tag} Hesabın ${memberGün} ${memberAylar} ${memberTarih} tarihinde oluşturulmuş. ${guvenilirlik ? `Şüpheli! ${red}` : `Güvenli! ${green}` }\n 
${tag} Sunucuya erişebilmek için "V. Confirmed" odalarında kayıt olup isim yaş belirtmen gerekmektedir.\n
${tag} Sunucu kurallarımız ${kurallar} kanalında belirtilmiştir. Unutma sunucu içerisinde ki ceza işlemlerin kuralları okuduğunu varsayarak gerçekleştirilecek.\n
${tag} Seninle beraber **${üyesayısı}** kişiyiz.Sunucu Özel URL tarafından davet edildin! :tada: :tada: :tada:`);
channel.wsend(`${girdi} ${member}, sunucuya katıldı! Davet Eden: **Sunucu Özel URL** :tata: :tata:`)
return }
...
channel.wsend(`${girdi} ${member}, ${invite.inviter.tag} davetiyle katıldı! (**${total}**)`)
...
${tag} Sunucuya erişebilmek için "V. Confirmed" odalarında kayıt olup isim yaş belirtmen gerekmektedir.\n
${tag} Sunucu kurallarımız ${kurallar} kanalında belirtilmiştir. Unutma sunucu içerisinde ki ceza işlemlerin kuralları okuduğunu varsayarak gerçekleştirilecek.\n
${tag} Seninle beraber **${üyesayısı}** kişiyiz.${invite.inviter} tarafından davet edildin ve bu kişinin ${total} daveti oldu!`);
channel.wsend(`${girdi} ${member}, ${invite.inviter.tag} davetiyle katıldı! (**${total}** Davet${green})`)
}
