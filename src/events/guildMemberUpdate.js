...
.setColor("RANDOM")
.setDescription(`${icon} Kişinin eklenen ve alınan tüm rollerine bakmak için \`.rollog\` komutunu kullanın \n
**Rol Eklenen kişi**\n ${hedef} - **${hedef.id}** `)
...
.setAuthor(hedef.tag, hedef.displayAvatarURL({ dynamic: true }))
.setColor("RANDOM")
.setDescription(`${icon} Kişinin alınan ve eklenen tüm rollerine bakmak için \`.rollog \` komutunu kullanın \n
**Rolü Alınan kişi** \n${hedef} - **${hedef.id}**`)
