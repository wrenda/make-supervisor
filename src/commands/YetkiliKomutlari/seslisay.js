...
const { red, green, star, Revuu, kirmiziok , mikrafon , kulaklık } = require("../../configs/emojis.json")
module.exports = {
  conf: {
...
${kirmiziok} Mikrofonu kapalı: ${kulaklık}**${mik}**
${kirmiziok} Kulaklığı kapalı: ${mikrafon}**${kulak}**
