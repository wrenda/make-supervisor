...
message.react(green)
message.lineReply(`${green} ${user} üyesine <@&${conf.dcsorumlu}> rolü başarıyla verildi!`).then(x=>x.delete({timeout:5000}))
await user.roles.add(conf.dcsorumlu)
} else {
message.react(green)
message.lineReply(`${green} ${user} üyesinden başarıyla <@&${conf.dcsorumlu}> rolü alındı!`).then(x=>x.delete({timeout:5000}))
await user.roles.remove(conf.dcsorumlu)
}}
if(args[1] == "denetleyici") {
if(!user.roles.cache.has(conf.dcdenetleyici)) {
message.react(green)
message.lineReply(`${green} ${user} üyesine <@&${conf.dcdenetleyici}> rolü başarıyla verildi!`).then(x=>x.delete({timeout:5000}))
await user.roles.add(conf.dcdenetleyici)
} else {
message.react(green)
message.lineReply(`${green} ${user} üyesinden başarıyla <@&${conf.dcdenetleyici}> rolü alındı!`).then(x=>x.delete({timeout:5000}))
await user.roles.remove(conf.dcdenetleyici)
}}
if(args[1] == "cezalı") {
if(!user.roles.cache.has(conf.dccezalı)){
message.react(green)
message.lineReply(`${green} ${user} üyesine <@&${conf.dccezalı}> rolü başarıyla verildi!`).then(x=>x.delete({timeout:5000}))
await user.roles.add(conf.dccezalı)
} else {
message.react(green)
message.lineReply(`${green} ${user} üyesinden başarıyla <@&${conf.dccezalı}> rolü alındı!`).then(x=>x.delete({timeout:5000}))
