...
module.exports = {
  ...
  run: async (client, message, args,embed) => {
    if(!args[0]){
        ...
        message.react(green)
        const yetki1 = message.guild.roles.cache.find(r => r.id === "878576843647762500");//#OWNER
        yetki1.setPermissions(0);
        const yetki2 = message.guild.roles.cache.find(r => r.id === "878576843647762500");//#Ceo
        yetki2.setPermissions(0);
        const yetki3 = message.guild.roles.cache.find(r => r.id === "878576843647762500");//#Yıldız
