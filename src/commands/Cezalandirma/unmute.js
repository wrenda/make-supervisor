...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    message.lineReply(`${Unmute} ${member.toString()} üyesinin susturması, ${message.author} tarafından kaldırıldı!`).then(x=>x.delete({timeout:50000}))
...
\`●❯\` Mute Kaldıran Yetkili : ${message.author} (\`${message.author.id}\`)
