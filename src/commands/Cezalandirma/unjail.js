...
module.exports = {
  ...
  run: async (client, message,  args, embed) => {
    ...
    message.react(green)
    message.lineReply(`${miniicon} ${member.toString()} üyesinin jaili ${message.author} tarafından kaldırıldı!`).then(x=>x.delete({timeout:50000}))
